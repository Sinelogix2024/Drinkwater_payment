...
position: relative;"><a href="{{ url('/experience/1234') }}" style="font-size: 14px;font-weight:300;color:#000;font-family: europaRegular, sans-serif !important;"><i class="fas fa-arrow-circle-left"></i> BACK</a></div>
</div>
 </div>
