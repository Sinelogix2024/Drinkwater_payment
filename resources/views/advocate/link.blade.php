                    ...
                    <div class="form_wrapper">
                                ...
                                <div class="form_field">
                                    <div class="text-field">
                                        <select class="selectpicker form-control" name="alakline_pure" id="alakline_pure"
                                            ...
                                            <option
                                                data-hidden="true">{{config('constants.package.default_drop_down_alakline_text')}}</option>
                        ...
                        <div class="flex_row">
                            ...
                            <div class="flex_col_sm_6">
                                <div class="form_field">
                                    <div class="text-field">
                                        <select class="selectpicker delivery_frequency1" name="delivery_frequency" id="delivery_frequency1"
                                                required data-dropup-auto="false"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6" id="BillData">
                                    ...
                                    <div class="form-group">
                                        <input type="text" value="" name="billing_address" id="billing_address"
                                               placeholder="DELIVERY ADDRESS1">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" value="" name="billing_address2" id="billing_address2"
                                               placeholder="DELIVERY ADDRESS2">
                                    </div>

                                    <div class="form-group">
                                        <input type="text" value="" name="b_city_state_zip" id="b_city_state_zip"
                            ...
                            <div class="flex_row">
                                <div class="flex_col_sm_12">
                                    ...
                                    <div class="form_field">
                                        <div class="text-field">
                                            ...
                                            <select class="selectpicker custom_select" title="DELIVERY FREQUENCY"
                                                ...
                                                <option value="" data-hidden="true"
                                                        title="{{config('constants.package.delivery_freq_text')}}">{{config('constants.package.delivery_freq_text')}}</option>
                                                <option value="1" selected>EVERY SUNDAY</option>
                                                <option value="2">EVERY MONDAY</option>
                                            </select>
                                        ...
                                        <span
                                            class="text-note delivery_note_final_page">EVERY SUNDAY FOR 1 MONTH </span>
                                        <span class="text-note">(1st DELIVERY 4 KITS, THEN 2 KITS THEREAFTER). </span>
                                    </div>
