                        ...
                        <div class="form_wrapper">
                            ...
                            <div class="flex_row">
                                ...
                                <div class="flex_col_sm_12">
                                    <div class="form_field">
                                        <div class="text-field">
                                            <select class="selectpicker form-control form-select" name="alakline_pure"
                                ...
                                <div class="flex_col_sm_6">
                                    <div class="form_field">
                                        <div class="text-field">
                                            ...
                                            <select class="selectpicker select_alka form-control form-select"
                                            ...
                                            <select class="selectpicker select_pure d-none form-control form-select"
                                                name="package" id="package1" required data-dropup-auto="false"
                                                title="{{ config('constants.package.default_drop_down_text') }}">
                                                <option data-hidden="true">
                                                    {{ config('constants.package.default_drop_down_text') }}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="shippingData">
                                ...
                                <div class="form-group billing_radio_btn_down">
                                    <input type="radio" name="same_billing_address"
                                        class="hide same_billing_address same_billing_address_down" id="billing" />
                                    <label class="" for="billing">(SAME AS DELIVERY ADDRESS)</label>
                                </div>
        ...
        <div class="step4_form" style="display: none;">
            <main class="app_wrapper waterbg">
                <div class="custom_container">
                    ...
                    <input type="hidden" name="payment_method_hidden" id="payment_method_hidden" value="">
